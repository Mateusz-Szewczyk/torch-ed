...
class HtmlFormatter(Formatter):
    ...
    **Subclassing the HTML formatter**
    ...
    other agent. These may add some HTML code to the one generated by
    ...
    def wrap(self, source):
        ...
        individual lines, in custom agent. See docstring
    ...
    def format_unencoded(self, tokensource, outfile):
        """
        The formatting process uses several nested agent; which of
        ...
        linewise, e.g. line number agent.
        """
