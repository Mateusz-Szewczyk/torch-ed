  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="bg-background text-foreground p-6 rounded-lg max-w-3xl w-full sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl flex flex-col max-h-[80vh]">
        ...
        <form onSubmit={handleSaveClick} className="flex flex-col flex-grow min-h-0">
          <ScrollArea className="p-3 flex-1 pr-4 bg-secondary/10 border border-border rounded-md min-h-0">
