...
export function LeftPanel() {
  ...
  // Removed theme destructuring since it's not used
  ...
  return (
    <div
      className={`bg-background text-foreground border-r border-border transition-all duration-300 ${
        isPanelVisible ? 'w-64' : 'w-16'
      } flex flex-col`}
    >
